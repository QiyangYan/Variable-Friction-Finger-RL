...
class Agent:
    ...
    def store(self, mini_batch, stuck_episode):
        for batch in mini_batch:
            self.memory.add(batch)
        self._update_normalizer(mini_batch, stuck_episode)
    ...
    def _update_normalizer(self, mini_batch, stuck_episode):
        states, goals = self.memory.sample_for_normalization(mini_batch, stuck_episode)
