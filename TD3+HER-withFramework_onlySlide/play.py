...
class Play:
    def __init__(self, env, agent,ENV_NAME, max_episode=4):
        ...
        self.agent = agent
        self.agent.load_weights("/Users/qiyangyan/Desktop/IHM_finger/TD3+HER-withFramework/Pre-trained models/VariableFriction-v0_considerRewardwithBothFrictionAndMotor.pth")
